...
class O3PO_Settings extends O3PO_Singleton {
    ...
    private function specify_sections_and_fields() {
        ...
        $this->specify_field('page_template_abstract_header', 'Show a heading for the abstract', array( $this, 'render_page_template_abstract_header_setting' ), 'plugin_settings', 'plugin_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('journal_title', 'Journal title', array( $this, 'render_journal_title_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('journal_subtitle', 'Journal subtitle', array( $this, 'render_journal_subtitle_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('journal_description', 'Journal description', array( $this, 'render_journal_description_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('publisher', 'Publisher', array( $this, 'render_publisher_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('secondary_journal_title', 'Secondary journal title', array( $this, 'render_secondary_journal_title_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('publisher_country', 'Country of publisher', array( $this, 'render_publisher_country_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('license_name', 'License name', array( $this, 'render_license_name_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), 'Creative Commons Attribution 4.0 International (CC BY 4.0)');
        $this->specify_field('license_type', 'License type', array( $this, 'render_license_type_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), 'CC BY');
        $this->specify_field('license_version', 'License version', array( $this, 'render_license_version_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), '4.0');
        ...
        $this->specify_field('license_explanation', 'License explanation string', array( $this, 'render_license_explanation_setting' ), 'journal_settings', 'journal_settings', array(), array($this, 'trim_settings_field'), 'Copyright remains with the original copyright holders such as the authors or their institutions.');

        $this->specify_section('crossref_settings', 'Crossref', array( $this, 'render_crossref_settings' ), 'crossref_settings');
        $this->specify_field('crossref_id', 'Crossref ID', array( $this, 'render_crossref_id_setting' ), 'crossref_settings', 'crossref_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('crossref_pw', 'Crossref password', array( $this, 'render_crossref_pw_setting' ), 'crossref_settings', 'crossref_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('crossref_archive_locations', 'Archive locations', array( $this, 'render_crossref_archive_locations_setting' ), 'crossref_settings', 'crossref_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('ads_api_token', 'ADS API token', array( $this, 'render_ads_api_token_setting' ), 'ads_settings', 'ads_settings', array(), array($this, 'trim_settings_field'), '');

        $this->specify_section('clockss_settings', 'Clockss', array( $this, 'render_clockss_settings' ), 'clockss_settings');
        $this->specify_field('clockss_ftp_url', 'Clockss FTP URL', array( $this, 'render_clockss_ftp_url_setting' ), 'clockss_settings', 'clockss_settings', array(), array($this, 'trim_settings_field'), 'ftp.clockss.org'); #cannot use validate_url here because it prepends https:// or ftp:// and we want to save the raw url
        $this->specify_field('clockss_username', 'Clockss Username', array( $this, 'render_clockss_username_setting' ), 'clockss_settings', 'clockss_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('clockss_password', 'Clockss Password', array( $this, 'render_clockss_password_setting' ), 'clockss_settings', 'clockss_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('doaj_api_key', 'DOAJ API key', array( $this, 'render_doaj_api_key_setting' ), 'doaj_settings', 'doaj_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('arxiv_doi_feed_identifier', 'Indentifier for the DOI feed', array( $this, 'render_arxiv_doi_feed_identifier_setting' ), 'arxiv_settings', 'arxiv_settings', array(), array($this, 'trim_settings_field'), '');
        $this->specify_field('arxiv_paper_doi_feed_endpoint', 'Endpoint for the arXiv DOI feed', array( $this, 'render_arxiv_paper_doi_feed_endpoint_setting' ), 'arxiv_settings', 'arxiv_settings', array(), array($this, 'trim_settings_field_ensure_not_empty_and_schedule_flush_rewrite_rules_if_changed'), 'arxiv_paper_doi_feed');
        ...
        $this->specify_field('buffer_access_token', 'Access token from buffer.com', array( $this, 'render_buffer_access_token_setting' ), 'buffer_settings', 'buffer_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('facebook_app_id', 'Facebook app_id', array( $this, 'render_facebook_app_id_setting' ), 'other_service_settings', 'other_service_settings', array(), array($this, 'trim_settings_field'), '');
        ...
        $this->specify_field('relevanssi_mime_types_to_exclude', 'Relevanssi mime types to exclude', array( $this, 'render_relevanssi_mime_types_to_exclude_setting' ), 'other_plugins_settings', 'other_plugins_settings', array(), array($this, 'trim_settings_field'), '#(application/.*(tar|gz|gzip)|text/.*tex)#u');
    ...
    public function render_relevanssi_index_pdfs_asynchronously_setting() {
         ...
         */
    public function trim_settings_field_ensure_not_empty_and_schedule_flush_rewrite_rules_if_changed( $id, $input ) {
