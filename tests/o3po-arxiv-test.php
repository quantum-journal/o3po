...
',
            ...
            array(
                'eprint' => '0809.2542v4',
                'expected' => array(
                    'arxiv_fetch_results' => 'ERROR: It seems like https://arxiv.org/abs/0809.2542v4 is not published under one of the three creative commons licenses (CC BY 4.0, CC BY-SA 4.0, or CC BY-NC-SA 4.0). Please inform the authors that this is mandatory and remind them that we will publish under CC BY 4.0 and that, by our terms and conditions, they grant us the right to do so.
',
